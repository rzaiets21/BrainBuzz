...
public class TestIAP : MonoBehaviour
{
    ...
    void Start()
    {
        buttonWidth = UnityEngine.Screen.width;
        padding = UnityEngine.Screen.width / 6;
    }


    void OnGUI()
    {
        buttonHeight = UnityEngine.Screen.height / (12 + nonCOnsumableProducts.Count + subscriptions.Count);
        ...
        if (GUI.Button(new Rect(0, UnityEngine.Screen.height - buttonHeight, UnityEngine.Screen.width / 3, buttonHeight), "Hide/Show Buttons"))
        {
