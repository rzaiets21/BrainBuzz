    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        void Refresh ()
        {
            ...
            if (safeArea != LastSafeArea
                || UnityEngine.Screen.width != LastScreenSize.x
                || UnityEngine.Screen.height != LastScreenSize.y
                || UnityEngine.Screen.orientation != LastOrientation)
            {
                ...
                LastScreenSize.x = UnityEngine.Screen.width;
                LastScreenSize.y = UnityEngine.Screen.height;
        ...
        Rect GetSafeArea ()
        {
            ...
            {
                Rect nsa = new Rect (0, 0, UnityEngine.Screen.width, UnityEngine.Screen.height);

                switch (Sim)
                {
                    case SimDevice.iPhoneX:
                        if (UnityEngine.Screen.height > UnityEngine.Screen.width)  // Portrait
                            nsa = NSA_iPhoneX[0];
                        else  // Landscape
                            nsa = NSA_iPhoneX[1];
                        break;
                ...
                safeArea = new Rect (UnityEngine.Screen.width * nsa.x, UnityEngine.Screen.height * nsa.y, UnityEngine.Screen.width * nsa.width, UnityEngine.Screen.height * nsa.height);
            }
        ...
        void ApplySafeArea (Rect r)
        {
            ...
            if (Logging)
            {
                ...
                name, r.x, r.y, r.width, r.height, UnityEngine.Screen.width, UnityEngine.Screen.height);
            }
        }
    }
}
