...
public class RevealsFinishParticles : MonoBehaviour
{
    ...
    public static RevealsFinishParticles Instance;
    ...
    public void ShowParticle(LetterHolderBase currentHolder, TileParticleType particleType = TileParticleType.CompleteRevealAnimation, Action onComplete = null)
    {
