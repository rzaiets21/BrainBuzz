...
public class ExampleGUI : MonoBehaviour
{
    ...
    void OnGUI()
    {
        if (showPopUp)
        {
            GUI.Window(0, new Rect((UnityEngine.Screen.width / 2) - 150, (UnityEngine.Screen.height / 2) - 65, 300, 130), ShowGUI, "Is SDK enabled?");
        }

        if (GUI.Button(new Rect(0, UnityEngine.Screen.height * 0 / numberOfButtons, UnityEngine.Screen.width, UnityEngine.Screen.height / numberOfButtons), txtManualLaunch))
        {
        ...
        if (GUI.Button(new Rect(0, UnityEngine.Screen.height * 1 / numberOfButtons, UnityEngine.Screen.width, UnityEngine.Screen.height / numberOfButtons), "Track Simple Event"))
        {
            AdjustEvent adjustEvent = new AdjustEvent("g3mfiw");
            Adjust.trackEvent(adjustEvent);
        }

        if (GUI.Button(new Rect(0, UnityEngine.Screen.height * 2 / numberOfButtons, UnityEngine.Screen.width, UnityEngine.Screen.height / numberOfButtons), "Track Revenue Event"))
        {
        ...
        if (GUI.Button(new Rect(0, UnityEngine.Screen.height * 3 / numberOfButtons, UnityEngine.Screen.width, UnityEngine.Screen.height / numberOfButtons), "Track Callback Event"))
        {
        ...
        if (GUI.Button(new Rect(0, UnityEngine.Screen.height * 4 / numberOfButtons, UnityEngine.Screen.width, UnityEngine.Screen.height / numberOfButtons), "Track Partner Event"))
        {
        ...
        if (GUI.Button(new Rect(0, UnityEngine.Screen.height * 5 / numberOfButtons, UnityEngine.Screen.width, UnityEngine.Screen.height / numberOfButtons), txtSetOfflineMode))
        {
        ...
        if (GUI.Button(new Rect(0, UnityEngine.Screen.height * 6 / numberOfButtons, UnityEngine.Screen.width, UnityEngine.Screen.height / numberOfButtons), txtSetEnabled))
        {
        ...
        if (GUI.Button(new Rect(0, UnityEngine.Screen.height * 7 / numberOfButtons, UnityEngine.Screen.width, UnityEngine.Screen.height / numberOfButtons), "Is SDK Enabled?"))
        {
